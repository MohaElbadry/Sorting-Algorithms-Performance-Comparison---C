...
int main()
{
    ...
    for (arr_size = 1000; arr_size <= 10000; arr_size = arr_size + 1000)
    {
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            bubblefile = j == 0 ? fopen("bubbledata(rand).txt", "a") : j == 1 ? fopen("bubbledata(ord).txt", "a")
                                                                              : fopen("bubbledata(rev).txt", "a");
            ...
            selectionfile = j == 0 ? fopen("selectiondata(rand).txt", "a") : j == 1 ? fopen("selectiondata(ord).txt", "a")
                                                                                    : fopen("selectiondata(rev).txt", "a");
            ...
            insertionfile = j == 0 ? fopen("insertiondata(rand).txt", "a") : j == 1 ? fopen("insertiondata(ord).txt", "a")
                                                                                    : fopen("insertiondata(rev).txt", "a");
            ...
            mergefile = j == 0 ? fopen("mergedata(rand).txt", "a") : j == 1 ? fopen("mergedata(ord).txt", "a")
                                                                            : fopen("mergedata(rev).txt", "a");
            ...
            quickfile = j == 0 ? fopen("quickdata(rand).txt", "a") : j == 1 ? fopen("quickdata(ord).txt", "a")
                                                                            : fopen("quickdata(rev).txt", "a");
